  ...
  <el-container class="home-container">
    ...
    <el-main class="content-main">
      <div style="margin: 0;padding: 0">
        ...
        <div
          v-bind:style="$route.path =='/myApply'||$route.path =='/myApproval'||$route.path =='/myReview'||$route.path =='/imsiConver'?'background: #fff;margin: 10px 0 0 0;padding: 10px':'margin: 10px 0 0 0'">
