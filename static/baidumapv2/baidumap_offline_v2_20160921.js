(function () {
  ...
  */
  ...
  var Rb = {
    /*guoguo 这是加载模块的名字 map_tk0ryi  http://api0.map.bdimg.com/getmodules?v=2.0&mod=模块1,模块2 */
      ...
      if (!this.map.Ub() && (a ? this.map.K.s_ = a : a = this.map.K.s_, a)) for (var c = p, c = "2" == z.ou ? [z.url.proto + z.url.domain.main_domain_cdn.other[0] + "/"] : [z.url.proto + z.url.domain.main_domain_cdn.baidu[0] + "/", z.url.proto + z.url.domain.main_domain_cdn.baidu[1] + "/", z.url.proto + z.url.domain.main_domain_cdn.baidu[2] + "/"], d = 0, e; e = this.Km[d]; d++) if (e.f_ == o) {
        ...
        e.getTilesUrl = function (b, d) {
          var e = b.x,
            ...
            l = 1;
          this.map.dE() && (l = 2);
          if (bdmapcfg.off_line) {
            var tdir = bdmapcfg.tiles_midnight.length > 0 ? bdmapcfg.tiles_midnight : bdmapcfg.home + "tiles_midnight";
            /*guoguo 使用本地卫星的瓦片 */
            tdir = tdir + "/" + d + "/" + e + "/" + k + bdmapcfg.imgext;
            /*guoguo 使用本地卫星的瓦片 */
            return tdir;
          } else {
  ...
  Vc.getTilesUrl = function (a, b, c) {
    ...
    a = a.y;
    e = 1;
    if (bdmapcfg.off_line) {/*使用本地的瓦片 */
      var tdir = bdmapcfg.tiles_dir.length > 0 ? bdmapcfg.tiles_dir : bdmapcfg.home + "tiles";
